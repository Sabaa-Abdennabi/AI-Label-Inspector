  ...
  return (
    <div className="bg-gray-100 w-full min-h-screen flex flex-col items-center p-6">
      ...
      <div className="w-full max-w-6xl bg-white shadow-lg rounded-xl p-6 flex flex-col lg:flex-row items-center justify-between">
        <h2 className="text-3xl font-bold text-blue-600">Upload Your Label</h2>
        <div className="flex items-center space-x-4 mt-4 lg:mt-0">
          <Datepicker value={value} onChange={handleValueChange}  />
          <button
            onClick={appLogout}
            className="flex items-center bg-gray-200 hover:bg-blue-600 text-blue-600 hover:text-white px-4 py-2 rounded-lg shadow transition"
          >
            <svg
